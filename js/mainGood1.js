...
App.Views.Person = Backbone.View.extend({
	...
	editPerson: function(){
		...
		var newOccupation = prompt("Please enter the new age", this.model.get('occupation'));
		var newGender = prompt("Please enter the new age", this.model.get('gender'));
...
App.Views.AddPerson = Backbone.View.extend({
	...
	//this.collection.add(persondefault);
	this.collection.add(person);//persondefault
